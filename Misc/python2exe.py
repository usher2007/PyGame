...
class BuildExe:
    def __init__(self):
        ...
        # 起始py文件
        self.script = "BouncingBall.py"
        # 游戏名
        self.project_name = "BouncingBall"
        # 游戏site
        ...
        # 游戏作者
        self.author_name = "doba"
        # 联系电邮
        self.author_email = "usher.guo@outlook.com"
        # 游戏版权
        self.copyright = "Copyright (c) 3000 doba."
        # 游戏描述
        self.project_description = "MyGames Description"
        # 游戏图标(None的话使用pygame的默认图标)
        self.icon_file = None
        # 额外需要拷贝的文件、文件夹(图片，音频等)
        self.extra_datas = ['ball.png', 'mousecursor.png', 'bounce.ogg']
        # 额外需要的python库名
        self.extra_modules = []
        # 需要排除的python库
